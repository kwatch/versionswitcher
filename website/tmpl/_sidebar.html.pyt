...
<li>
  <div id="download" >
    ...
    <?py #endif ?>
    <div>
      <a href="https://versionswitcher.appspot.com/install.sh">DOWNLOAD<div id="download-version">(version 0.3.0)</div></a>
    </div>
  </div>
...
<li>
  <h2>About</h2>
  <p>VersionSwitcher is a small utility to switch versions of programming languages and applications.</p>
</li>
-->
...
<li>
  ...
  <ul>
    ...
    <li>Lua, LuaJIT</li>
    <li>Perl</li>
    <li>Lisp, Scheme, Gauche</li>
    <li>...and any other languages</li>
  </ul>
</li>
-->
