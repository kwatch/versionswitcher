...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
			...
			<li #{d.get('/blog')}><a href="/blog.html">Blog</a></li>
			<li #{d.get('/photos')}><a href="/photos.html">Photos</a></li>
			<li #{d.get('/about')}><a href="/about.html">About</a></li>
			<li #{d.get('/links')}><a href="/links.html">Links</a></li>
			<li #{d.get('/contact')}><a href="/contact.html">Contact</a></li>
		</ul>
	</div><!-- /menu -->
